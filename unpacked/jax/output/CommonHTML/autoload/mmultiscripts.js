    ...
    toCommonHTML: function(node, options) {
      ...
      if (!sup && !presup) {
        ...
        if (!sub && !presub) {
          ...
          if (sup) {
            if (sub) {
              this.CHTMLplaceSubSup(sub, sbox, sup, Sbox, x, delta, u, v, s);
            } else {
              this.CHTMLplaceSupOnly(sup, Sbox, x, delta, u, s);
            }
          } else if (sub) {
            this.CHTMLplaceSubOnly(sub, sbox, x, v, s);
          }
          if (presup) {
            if (presub) {
            ...
            this.CHTMLplacePresubOnly(presub, pbox, v, s);
          }
        }
      }
      this.CHTML.clean();
